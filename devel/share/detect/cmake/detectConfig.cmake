...
if("TRUE" STREQUAL "TRUE")
  set(detect_SOURCE_PREFIX /home/gabriel/vision_ws/src/detect)
  set(detect_DEVEL_PREFIX /home/gabriel/vision_ws/devel)
  set(detect_INSTALL_PREFIX "")
  set(detect_PREFIX ${detect_DEVEL_PREFIX})
else()
  set(detect_SOURCE_PREFIX "")
  set(detect_DEVEL_PREFIX "")
  set(detect_INSTALL_PREFIX /home/gabriel/vision_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gabriel/vision_ws/src/detect/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(detect_EXPORTED_TARGETS ${${detect_dep}_EXPORTED_TARGETS})
endforeach()
